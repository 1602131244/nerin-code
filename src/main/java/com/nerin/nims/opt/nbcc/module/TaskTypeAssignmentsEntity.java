 ...
 */
public class TaskTypeAssignmentsEntity extends OracleBaseEntity implements ORAData {
    private Long assignmentId;
    private String taskTypeCode;//文本类型编码
    private String assignmentType;//权限分配类型：create 创建、submit 检审提交
    ...
    public static final String _ORACLE_TYPE_NAME = "APPS.NBCC_TASK_TYPE_ASSIGNMENTS_REC";
    protected MutableStruct _struct;
    static int[] _sqlType = { OracleTypes.NUMBER, OracleTypes.VARCHAR, OracleTypes.VARCHAR, OracleTypes.NUMBER, OracleTypes.VARCHAR, OracleTypes.NUMBER
    ...
    public TaskTypeAssignmentsEntity() {
    ...
    public Datum toDatum(Connection connection) throws SQLException {
        ...
        _struct.setAttribute(2, this.getAssignmentType());
        _struct.setAttribute(3, this.getProjectRoleId());
        _struct.setAttribute(4, this.getSpecialty());
        _struct.setAttribute(5, this.getObjectVersionNumber());
        _struct.setAttribute(6, this.getAttributeCategory());
        ...
        _struct.setAttribute(17, this.getAttribute11());
        _struct.setAttribute(18, this.getAttribute12());
        _struct.setAttribute(19, this.getAttribute13());
        _struct.setAttribute(20, this.getAttribute14());
        _struct.setAttribute(21, this.getAttribute15());
        _struct.setAttribute(22, this.getLastUpdateDate());
        _struct.setAttribute(23, this.getLastUpdatedBy());
        _struct.setAttribute(24, this.getLastUpdateLogin());
        _struct.setAttribute(25, this.getCreatedBy());
        _struct.setAttribute(26, this.getCreationDate());
