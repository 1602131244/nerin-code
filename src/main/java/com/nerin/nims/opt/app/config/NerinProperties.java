...
/**
 * Created by Zach on 16/5/11.
 */
@Configuration
@ConfigurationProperties(prefix = "nerin", ignoreInvalidFields = false)
public class NerinProperties {
    private final Nbcc nbcc = new Nbcc();
    ...
    public static class Nbcc {
        ...
        public String getCadiDocFileUrl() {
            return cadiDocFileUrl;
        }

        public void setCadiDocFileUrl(String cadiDocFileUrl) {
            this.cadiDocFileUrl = cadiDocFileUrl;
        }
        ...
        public String getTcFileUrl() {
            return tcFileUrl;
        }

        public void setTcFileUrl(String tcFileUrl) {
            this.tcFileUrl = tcFileUrl;
        }
        ...
        public String getTemplateWordFileUrl() {
            return templateWordFileUrl;
        }

        public void setTemplateWordFileUrl(String templateWordFileUrl) {
            this.templateWordFileUrl = templateWordFileUrl;
        }
    ...
    public static class Mail {
        ...
        private String from = "hellojhs@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "Nerin API";

        private String description = "Nerin API documentation";
