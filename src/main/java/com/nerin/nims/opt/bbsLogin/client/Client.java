package com.nerin.nims.opt.bbsLogin.client;
...
public class Client extends PHPFunctions{
    ...
    public static String UC_IP = "192.168.15.71";
    public static String UC_API = "http://192.168.15.71/bbs/uc_server";
    public static String UC_CONNECT = "";
    public static String UC_KEY = "javaLogin123";
...
//		}
    ...
    protected String uc_fopen(String $url, int $limit, String $post, String $cookie, boolean $bysocket ,String $ip , int $timeout , boolean $block ) {
        ...
        try{
            ...
            if(!$fp.isConnected()) {
                return "can not connected!"+$fp;//note $errstr : $errno \r\n
            } else {
     ...
     * @return string 		HTML代码
     */
    public String uc_user_synlogin_by_email(String $email) {
        Map<String, Object> args = new HashMap<String, Object>();
        args.put( "uid",$email);
        args.put( "type","email");
        String $return = uc_api_post("user", "synlogin", args);
