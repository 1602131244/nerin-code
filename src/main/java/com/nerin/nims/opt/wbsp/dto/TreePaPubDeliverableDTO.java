 ...
 */
public class TreePaPubDeliverableDTO {
    ...
    private String authorNum;//创建人ID
    ...
    private PaOthersList otherslist;//其他参与人信息
    ...
    private String recvSpec; //j接收专业
    private String schedule; //进度
    private List<TreePaPubDeliverableDTO> children = new ArrayList<TreePaPubDeliverableDTO>();
    private List<TreePaPubDeliverableDTO> speChildren = new ArrayList<TreePaPubDeliverableDTO>();
    ...
    public List<TreePaPubDeliverableDTO> getChildren() {
        return children;
    }

    public void setChildren(List<TreePaPubDeliverableDTO> children) {
        this.children = children;
    }

    public List<TreePaPubDeliverableDTO> getSpeChildren() {
        return speChildren;
    }

    public void setSpeChildren(List<TreePaPubDeliverableDTO> speChildren) {
