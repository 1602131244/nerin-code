		...
		searcher: function (value) {
			if(!dgData[value]){
				...
				$('#macros').datagrid({
					...
					columns: [[{ field: 'name', title: '模块名称', width: 130 },
						{ field: 'password', title: '默认密码', width: 90 }]]
				}).datagrid('clearSelections');
			}
		}
	});	
...
var dgData = {
	...
	1601:{
		...
		"prjData":[
			{"id":000000,"name":"虚拟用户","unit":"系统管理员","role":"测试角色","uid":3085},
			{"id":100009,"name":"姚素平","unit":"总工办","role":"主管（副）总工程师","uid":2307},
			{"id":101215,"name":"李大浪","unit":"项目经理","role":"项目经理","uid":1403},
			{"id":100243,"name":"李大浪","unit":"结构","role":"A专业负责人","uid":1403},
			{"id":101108,"name":"李大浪","unit":"结构","role":"A专业设计人","uid":1403},
			{"id":100240,"name":"熊天屹","unit":"结构","role":"A专业校核人","uid":1412},
			{"id":100239,"name":"周丽霞","unit":"结构","role":"A专业审核人","uid":1418},
			{"id":100235,"name":"李大浪","unit":"结构","role":"A专业主任工程师","uid":1403},
			{"id":100615,"name":"彭修莲","unit":"建筑","role":"B专业负责人","uid":1441},
			{"id":100971,"name":"韦雯","unit":"总工办","role":"评审管理员","uid":1676}
		]
	},
	1602:{
