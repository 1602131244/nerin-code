...
$('#btnuserapply').linkbutton({//确定变更提交按钮
	...
	onClick: function () {
		...
		var postData = {
			...
			"editDoc":"http://"+window.location.host+"/pages/wbsp/code/getDoc/getDoc.html?requestid=",//编辑doc
			"viewDoc":pourl+"/DataRegionView.jsp?requestid=",//查看doc
			"getPdf":"http://"+window.location.host+"/pages/wbsp/code/getDoc/getPDF.html?requestid=",//获取pdf
			"xmbh":prjNumber,//项目编号
			"xmmc":prjName,//项目名称
			"sjjd":prjPhase,//设计阶段
